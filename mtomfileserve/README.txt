...
This will build the MTOMFileServe.aar in the build directory and copy it to the
...
http://<yourhost>:<yourport>/axis2/services/MTOMFileServe?wsdl 
(e.g. http://localhost:8080/axis2/services/MTOMFileServe?wsdl)

src/sample/mtomfileserve/rpcclient/mtomfileserveRPCClient.java is a Client that uses RPCServiceClient
...
src/sample/mtomfileserve/adbclient/mtomfileserveADBClient is Client that uses a generated stub with ADB
to invoke the methods of this web service.

To generate the stub, compile and run, type
$ant adb.client -Dwsdl=http://<yourhost>:<yourport>/axis2/services/MTOMFileServe?wsdl
